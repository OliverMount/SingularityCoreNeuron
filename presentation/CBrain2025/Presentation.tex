...
3. We address this issue using singularity containers that encapsulats the entire simulation environment, enabling neuroscientists to achieve portability and reproducibility without requiring root privileges on HPC and cloud systems.\\[0.3 cm]

4. We give a practical demonstrations by benchmarking HPC environments with mossy fiber$-$granule cell network simulations.
               }
            \end{block}
            \vspace{0.5cm}
...
\hline
\textcolor{red}{Number of MF}         & \textcolor{red}{~85,600} \\
\textcolor{violet}{Number of GRC}     & \textcolor{violet}{314,000} \\
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \caption{Turing architecture: Comparison of solver time for varying numbers of GPUs in CORENeuron-GPU simulator}
        \label{fig:turing}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\textwidth}
...
{\large Turing, Volta outperform 30-core CPUs by up to 4.5x, with performance improving as GPU count increases. \\[5 mm]

Volta GPUs are faster than Turing at equivalent GPU counts, offering better efficiency per device.}
